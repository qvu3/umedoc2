...
@Component({
  selector: 'app-patient-finished-registration',
  templateUrl: './patient-finished-registration.component.html',
  styleUrls: ['./patient-finished-registration.component.css']
})
export class PatientFinishedRegistrationComponent extends BaseComponent implements OnInit {
  returnUrl: string;
  model: UserModel;
  id: string;
