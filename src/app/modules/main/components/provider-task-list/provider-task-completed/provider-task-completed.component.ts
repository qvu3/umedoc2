...
@Component({
  selector: 'app-provider-task-completed',
  templateUrl: './provider-task-completed.component.html',
  styleUrls: ['./provider-task-completed.component.css']
})
export class ProviderTaskCompletedComponent extends BaseComponent implements OnInit {
  ...
  searchAsync() {
    this.criteria.Status = ProviderTaskStatus.Completed;
