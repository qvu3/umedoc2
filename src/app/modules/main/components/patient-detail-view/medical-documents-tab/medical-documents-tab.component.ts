...
@Component({
  selector: 'app-medical-documents-tab',
  templateUrl: './medical-documents-tab.component.html',
  styleUrls: ['./medical-documents-tab.component.css'],
  providers:[DatePipe]
})
export class MedicalDocumentsTabComponent extends BaseComponent
implements OnInit {
