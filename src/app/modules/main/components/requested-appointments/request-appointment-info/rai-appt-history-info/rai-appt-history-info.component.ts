...
@Component({
  selector: 'app-rai-appt-history-info',
  templateUrl: './rai-appt-history-info.component.html',
  styleUrls: ['./rai-appt-history-info.component.css']
})
export class RaiApptHistoryInfoComponent extends BaseComponent implements OnInit {
  id:string;
