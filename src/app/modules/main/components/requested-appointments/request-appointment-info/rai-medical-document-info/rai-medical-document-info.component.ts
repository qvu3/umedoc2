...
@Component({
  selector: 'app-rai-medical-document-info',
  templateUrl: './rai-medical-document-info.component.html',
  styleUrls: ['./rai-medical-document-info.component.css']
})
export class RaiMedicalDocumentInfoComponent extends BaseComponent implements OnInit {
  id:string;
