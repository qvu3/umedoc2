...
export class AppointmentSlotService extends BaseService<AppointmentSlotModel>{
    ...
    GetAvaiableVaccineAppointmentSlots(criteria) {
    ...
    GetDefaultAppointmentSlotsByProvider(criteria) {
    ...
    GetDefaultAppointmentSlotsByProviders(criteria) {
        let url = Global.apiUrl + `/api/AppointmentSlot/GetDefaultAppointmentSlotsByProviders`;
        return this.httpClient.post(url, criteria) as Observable<AppointmentSlotModel[]>;
    }

    GetAppointmentSlotsByProvider(providerID) {
    ...
    GetAvaiableAppointmentSlotsByProvider(startDate, providerID, isFU = false) {
    ...
    CheckAvailableAppointSlot(appointment) {
    ...
    GetAvaiableAppointmentSlots(appointment) {
