...
@Directive({
  selector: '[appInitAppChat]'
})
export class InitAppChatDirective  implements AfterViewInit{
  ...
  registerChat() {
    ...
    // if it is a touch device
      ...
      $(".chat-sidebar-list-wrapper").css("overflow", "scroll !important");
      $(".chat-user-profile-scroll").css("overflow", "scroll !important");
      $(".chat-container").css("overflow", "scroll !important");
      $(".chat-profile-content").css("overflow", "scroll !important");
    }
