...
@Component({
  selector: "app-step-countries",
  templateUrl: "./step-countries.component.html",
  styleUrls: ["./step-countries.component.css"],
})
export class StepCountriesComponent
  ...
  implements AfterViewInit
{
  ...
  countries: Array<Select2OptionData> = new Array<Select2OptionData>();
  ddlCountriesOption: Options;
  constructor(
